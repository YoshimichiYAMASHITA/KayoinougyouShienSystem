...
214～218行目のトラブル報告用メッセージについては、
最後に通知を行った画像についてのチェックになります。
"""